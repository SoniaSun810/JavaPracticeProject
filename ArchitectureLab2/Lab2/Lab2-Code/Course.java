...
public class Course {
    ...
    protected Integer countRegisteredStudent;
    protected Boolean isOverBooked;
    ...
    public void registerStudent(Student objStudent) {
        ...
        this.countRegisteredStudent += 1;
        if (this.countRegisteredStudent >= 3) {
