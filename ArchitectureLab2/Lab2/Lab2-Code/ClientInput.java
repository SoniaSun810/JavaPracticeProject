    ...
    public void run() { 
        try {
            ...
            while (true) {
                ...
                // Execute command 6: Register a student for a course. (check course conflict before register)
                if (sChoice.equals("6")) {
                    ...
                    EventBus.announce(EventBus.EV_SHOW, "\n");
                    EventBus.announce(EventBus.EV_CHECK_COURSE_CONFLICT, sSID + " " + sCID + " " + sSection);
                    // Invoke EventBus.EV_REGISTER_STUDENT in EventBus.EV_CHECK_COURSE_CONFLICT
