...
public class RegisterStudentHandler extends CommandEventHandler {
    ...
    protected String execute(String param) {
        ...
        String sConflicted = objTokenizer.nextToken();
        String sSID     = objTokenizer.nextToken();
        String sCID     = objTokenizer.nextToken();
        String sSection = objTokenizer.nextToken();

        if (Integer.parseInt(sConflicted) == 1) return "Course Conflicts!";
        ...
        // Extract the course-conflict checking to a new component: CourseConflictHandler.
...
//        }
        ...
        /* Announces when a class is overbooked */
        /* But the student can still register */
        if (objCourse.isOverBooked) {
