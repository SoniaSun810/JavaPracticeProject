...
public class SinkFilter extends FilterFramework {
    public void run() {
        ...
        Double pressure = Double.valueOf(0);
        Double temperature = Double.valueOf(0);
        File csvFile = new File("OutputA.csv");
        ...
        while (true) {
            try {
                 ...
                 ****************************************************************************/
                //TODO how to set correct digit for double number?
                // TODO exception: 2020:01:10
                //Thread-0::End of file reached...
                //Thread-0::Read file complete, bytes read::6000 bytes written: 6000
                if (id == 4) {
                    temperature = Double.longBitsToDouble(measurement);
                    String sTime = TimeStampFormat.format(TimeStamp.getTime());
                    String sVelocity = Double.toString(velocity);
                    String sAltitude = Double.toString(altitude);
                    String sPressure = Double.toString(altitude);
                    String sTemperature = Double.toString(temperature);
                    String toWrite = sTime + "," + sVelocity + "," + sAltitude + "," + sPressure + "," + sTemperature + "\n";
